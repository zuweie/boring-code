...
#define container_find(container_ptr, find, compare) container_search(container_ptr, container_first(container_ptr), find, compare)

// 根据插入的东东计算插入的位置。不需要 iterator 来指明，有特殊的数据结构，例如红黑树，hashmap
#define container_set(container_ptr, data, setup, conflict_fix) (((container_t*)(container_ptr))->set(((container_t*)(container_ptr)), data, setup, conflict_fix))

// 容器插入
#define container_insert(container_ptr, iter, data) (((container_t*)(container_ptr))->insert(((container_t*)(container_ptr)), iter, data))
#define container_insert_find(container_ptr, find, data, compare) container_insert(container_ptr, container_find(container_ptr, find, compare), data)
#define container_insert_first(container_ptr, data) container_insert(container_ptr, container_first(container_ptr), data)
#define container_insert_tail(container_ptr, data) container_insert(container_ptr, container_tail(container_ptr), data)
...
// 容器排序
#define container_sort(container_ptr, compare) ((container_t*)(container_ptr))->sort((container_t*)(container_ptr), compare)

// 容器挤水
#define container_wring(container_ptr, compare, callback) (((container_t*)(container_ptr))->wring(((container_t*)(container_ptr)), compare, callback))
