 ...
 * @LastEditTime: 2023-06-27 15:30:22
...
int navie_bayes_train_MGD_edit(matrix2_t* train_mat, matrix2_t* train_label_mat, void** Py_counting, void** mus, void** sigma_table);
