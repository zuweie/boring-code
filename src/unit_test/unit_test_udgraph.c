 ...
 * @LastEditTime: 2020-12-08 16:02:19
...
{
    UDGraph* graph = UDGraph_create(udgraph_match_vertex, udgraph_match_edge_2p, 0);
    ...
    ugrp_calculate_mst_kruskal(graph, list, entity_int_insert_cmp);
