 ...
 * @LastEditTime: 2021-02-26 16:18:04
...
#define __indicators(_p_marco_indicator, marco_axis, marco_picked, marco_start, marco_tail) \
    ({ \
        ua_indicator_t* __p_indicator = _p_marco_indicator; \
        void* p = UA_indicator_create(marco_axis, marco_picked, marco_start, marco_tail); \
        UA_indicator_addto(&__p_indicator, p); \
        _p_indicator; \
    })

#define __indicators_picked(_p_marco_indicator, marco_axis, marco_picked) __indicators(_p_marco_indicator, marco_axis, marco_picked, 0, 0)
#define __indicators_start_tail(_p_marco_indicator, marco_axis, marco_start, marco_tail) __indicators(_p_marco_indicator, marco_axis, -1, marco_start, marco_tail)
#define __indicators_start(_p_marco_indicator, marco_axis, marco_start) __indicators(_p_marco_indicator, marco_axis, -1, marco_start, 0)
#define __indicators_tail(_p_marco_indicator, marco_axis, marco_tail) __indicators(_p_marco_indicator, marco_axis, -1, 0, marco_tail)
