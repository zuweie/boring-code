 ...
 * @LastEditTime: 2024-09-04 12:19:54
...
// 最重要这三个函数。
int compute_graph_forward_propagation(compute_graph_t* p_compute_graph, const char* str_zid);
int compute_graph_build_gradient(compute_graph_t* p_compute_graph, const char* str_zid, const char* str_uid);

compute_node_t* compute_create_mediate_node(const char* id, int (*recycle)(compute_node_t*), int (*fp)(compute_node_t*, void*), int (*bp)(compute_node_t*, void*), int (*update_payload)(comute_node_t*, void*));
compute_node_t* compute_create_input_node(const char* id, matrix2_t* input, int(*recycle)(compute_node_t*), int (*bp)(compute_node_t*, void*), int(*update_payload)(compute_node_t*, void*));
compute_node_t* compute_create_training_params_node(const char* id, matrix2_t* training_params, int(*recycle)(compute_node_t*), int (*bp)(compute_node_t*, void*), int(*update_payload)(compute_node_t*, void*));

int compute_set_input(compute_graph_t* p_compute_graph, const char* str_id, matrix2_t* p_input);
