 ...
 * @LastEditTime: 2026-08-22 22:59:50
...
typedef struct cg_node {
    cg_vertex_t        vertex;
    cg_node_opt_type_t node_type;
} cg_node_t;

static inline int cg_node_init(cg_node_t* thiz, const char* id, cg_node_opt_type_t node_type) 
{
    thiz->node_type = node_type;
    return cg_vertex_init(thiz, id);
}
