...
static inline int __linear_calc(cg_operator_t* thiz, cg_operand_t* out)
{
...
static inline int __linear_diff(cg_operator_t* thiz, cg_operand_t* variant, cg_operand_t* in_gard)
{
    linear_opt_t* operator = (linear_opt_t*) thiz;
    nn_operand_t* x        = operator->x;
    nn_operand_t* W        = operator->W;
