...
static int __dot_bp(cg_znode_base_t* znode, void* param) 
{
    return 0;
}
...
static int __plus_bp(cg_znode_base_t* znode, void* param) 
{
    return 0;
}
...
static int __relu_bp(cg_znode_base_t* znode, void* param)
{
    return 0;
}
...
static int __softmax_bp(cg_znode_base_t* znode, void* param)
{
    return 0;
}
...
static int __cross_bp(cg_znode_base_t* znode, void* param)
{
    return 0;
}
