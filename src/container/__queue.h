 ...
 * @LastEditTime: 2020-10-24 20:18:28
...
#define Queue_init(queue, search_cmp, sort_cmp, wring_cmp, wring_cb, cleanup) CN_initialize(ls, list, search_cmp, NULL, sort_cmp, wring_cmp, wring_cb, cleanup)
